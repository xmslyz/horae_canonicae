...
with open("index_lau.json", encoding="utf-8") as f:
    index = json.load(f)
...
try:
    to_rip = ['HYMN', 'PSALM1', 'PSALM2', 'PSALM3', 'LECTURE', 'RESPONSORY', 'PETITIONS', 'PRAYER', "ZACHARY"]
...
with open("ot/ot_lau.json", "w", encoding="utf-8") as f:
